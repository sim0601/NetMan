...
def get_data():
    ...
    try:                                        # try/except block for all errors
        ...
        with open(os.path.join(path + yml_file), 'w') as out:
            ...
            out.write('   loopbackIP: ' + ip_sub[1][:-3] + ' 255.255.255.255' + "\n")
            out.write('   interfaces:' + "\n")
            out.write('     ' + int_type[2] + int_name[2] + ": "+ ip_sub[2][:-3] + ' 255.255.255.0' + "\n")
            out.write('     ' + int_type[3] + int_name[3] + ": "+ ip_sub[3][:-3] + ' 255.255.255.0' + "\n")
            out.write('     ' + int_type[4] + int_name[4] + ": "+ ip_sub[4][:-3] + ' 255.255.255.0'+ "\n")
            out.write('   processID: ' + ospf_id[1] + "\n")
            out.write('   ospfNetwork: ' + "\n")
            out.write('     - ' + ip_sub[1][:-4] + '0 0.0.0.0' + "\n")
            out.write('     - ' + ip_sub[2][:-4] + '0 0.0.0.255' + "\n")
            out.write('     - ' + ip_sub[3][:-4] + '0 0.0.0.255' + "\n")
            out.write('     - ' + ip_sub[4][:-4] + '0 0.0.0.255' + "\n")
            ...
            out.write('   loopbackIP: ' + ip_sub[5][:-3] + ' 255.255.255.255' + "\n")
            out.write('   interfaces:' + "\n")
            out.write('     ' + int_type[6] + int_name[6] + ": "+ ip_sub[6][:-3] + ' 255.255.255.0' + "\n")
            out.write('     ' + int_type[7] + int_name[7] + ": "+ ip_sub[7][:-3] + ' 255.255.255.0' + "\n")
            out.write('   processID: ' + ospf_id[5] + "\n")
            out.write('   ospfNetwork: ' + "\n")
            out.write('     - ' + ip_sub[5][:-4] + '0 0.0.0.0' + "\n")
            out.write('     - ' + ip_sub[6][:-4] + '0 0.0.0.255' + "\n")
            out.write('     - ' + ip_sub[7][:-4] + '0 0.0.0.255' + "\n")
            ...
            out.write('   loopbackIP: ' + ip_sub[8][:-3] + ' 255.255.255.255'+ "\n")
            out.write('   interfaces:' + "\n")
            out.write('     ' + int_type[9] + int_name[9] + ": "+ ip_sub[9][:-3] + ' 255.255.255.0' + "\n")
            out.write('     ' + int_type[10] + int_name[10] + ": "+ ip_sub[10][:-3] + ' 255.255.255.0' + "\n")
            out.write('   processID: ' + ospf_id[8] + "\n")
            out.write('   ospfNetwork: ' + "\n")
            out.write('     - ' + ip_sub[8][:-4] + '0 0.0.0.0' + "\n")
            out.write('     - ' + ip_sub[9][:-4] + '0 0.0.0.255' + "\n")
            out.write('     - ' + ip_sub[10][:-4] + '0 0.0.0.255' + "\n")
